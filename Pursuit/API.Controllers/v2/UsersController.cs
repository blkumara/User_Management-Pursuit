...
/* =========================================================
 ...
 ============================================================ */
namespace Pursuit.API.Controllers.v2
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPost("AnotherFromV2API")]

        public async Task<IActionResult> ThisisAV2Method()
        {
            return Ok("Calling API version 2.0, coming from here api/v2");
        }
