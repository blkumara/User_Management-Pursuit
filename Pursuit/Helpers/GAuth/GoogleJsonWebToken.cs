...
namespace Pursuit.Helpers.GAuth
{
    public class GoogleJsonWebToken
    {
        public static string Encode(string email, string privateKeys)
        {
            ...
            return JsonWebToken.Encode(payload, privateKeys, JwtHashAlgorithm.RS256);
        }
    }
}
